<template>
    <div>
        <h1>Välkommmen till hitta programmerare!</h1>
        <h2>Hitta programmerare genom att söka i sökfältet uppe i högra hörnet</h2>
        <h2>Logga in eller skapa konto på knappen uppe i högra hörnet</h2>
